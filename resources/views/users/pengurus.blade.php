    ...
    <section class="max-w-screen-3xl mx-auto flex flex-col pt-32 pb-20 px-4 max-md:pt-28 sm:px-10">
        <div class="flex flex-col gap-8">
            ...
            <div class="grid grid-cols-3 gap-10 max-lg:grid-cols-2 max-sm:grid-cols-1 max-md:gap-6">
                {{-- ? card pembungkus --}}
                @for ($i = 0; $i < 5; $i++)
                <div onclick="window.location='{{ route('user.homepage') }}'"
                    ...
                    <div class="overflow-hidden">
                        <img src="{{ asset('uploads/pengurus/maudyayunda.jpg') }}" alt=""
                    ...
                    <div
                        ...
                        <h5 class="text-lg font-medium uppercase max-xl:text-base max-md:text-sm">bendahara</h5>
                        <h1
