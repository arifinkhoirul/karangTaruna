        ...
        <div class="flex flex-col gap-8">
            ...
            <div class="flex flex-col gap-2 max-md:gap-2 overflow-hidden">
                ...
                <div class="flex flex-col gap-4 max-md:gap-2">
                    <p class="text-lg font-light text-textSecondary max-lg:text-base max-md:text-sm leading-relaxed animate__animated animate__fadeInUp">Yuk kenalan sama orang-orang di balik kegiatan.</p>
            ...
            <div class="grid grid-cols-3 gap-10 max-lg:grid-cols-2 max-sm:grid-cols-1 max-md:gap-6">
                ...
                <div class="animate__animated animate__fadeInUpShort" style="animation-delay: {{ $index * 0.2 }}s">
                    <div onclick="window.location='{{ route('user.pengurus.show', $member->id) }}'"
                        class="relative block h-full rounded-2xl overflow-hidden cursor-pointer group shadow-[0_8px_30px_rgb(0,0,0,0.13)] group transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-[0_8px_30px_rgb(0,0,0,0.18)]">
