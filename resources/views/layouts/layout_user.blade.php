    ...
    <header class="fixed top-0 w-full bg-bg1 shadow-md z-50">
        <div
            ...
            <div class="flex flex-wrap items-center justify-between gap-5 w-full">
                ...
                <a href="{{ route('user.homepage') }}" class="hidden max-sm:block"><img src="{{ asset('logo-karangtaruna.png') }}"
                        alt="logo" class="w-12" /></a>
                ...
                <div class="flex gap-3 max-md:gap-2">
                    <a href='{{ route('login') }}'
                        class="px-5 py-2 text-xs rounded-xl font-medium cursor-pointer tracking-wide text-primary border border-primary bg-transparent  hover:bg-primary hover:text-white transition-all duration-300 ease-in-out md:px-6 md:py-3 md:text-sm animate-wiggle">Login</a>
        ...
        <div class="flex flex-row justify-between gap-8 max-lg:flex-col max-lg:gap-4 pb-8 max-md:pb-6">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex gap-4">
                    <a href="#">
                        <svg class="w-12 h-12 max-md:h-10 max-md:w-10 hover:opacity-80 transition-all duration-300 ease-in-out" viewBox="0 0 37 37" fill="none"
