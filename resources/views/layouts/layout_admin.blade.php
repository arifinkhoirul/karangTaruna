                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->is('admin/dashboard') ? 'active' : '' }}">
                            <a href="{{ route('admin.dashboad.index') }}" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        @if (session('utype') == 'sekre')
                            ...
                            <li class="sidebar-item {{ request()->is('admin/data-remaja*') ? 'active' : '' }}">
                                <a href="{{ route('admin.data-remaja.index') }}" class='sidebar-link'>
                            ...
                            <li
                                ...
                                <ul class="submenu ">
                                    ...
                                    <li
                                        class="submenu-item  {{ request()->is('admin/social-media*') ? 'active' : '' }}">
                            ...
                            <li class="sidebar-item {{ request()->is('admin/main-images*') ? 'active' : '' }}">
                                <a href="{{ route('admin.main-image.index') }}" class='sidebar-link'>
                        ...
                        @elseif (session('utype') == 'bendahara')
                        ...
                        @elseif (session('utype') == 'dokumentasi')
                        ...
                        <li class="sidebar-item">
                            <form method="POST" action="{{ route('logout') }}" class="">
                                @csrf
                                <button type="submit" class="btn btn-danger"><i class="bi bi-box-arrow-in-left"></i>
                                    logout</button>
                            </form>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('user.homepage') }}" class='mt-2 btn btn-sm btn-dark'>
